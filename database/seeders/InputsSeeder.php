...
class InputsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        \App\Models\Inputs::updateOrCreate(['id' => 6], ['title_ar' => 'من مدينة', 'title_en' => 'From City', 'name' => 'from_city', 'type' => 'text']);
        \App\Models\Inputs::updateOrCreate(['id' => 7], ['title_ar' => 'من حي', 'title_en' => 'From Neighborhood', 'name' => 'from_neighborhood', 'type' => 'text']);
        ...
        \App\Models\Inputs::updateOrCreate(['id' => 12], ['title_ar' => 'الي مدينة', 'title_en' => 'To City', 'name' => 'to_city', 'type' => 'text']);
        \App\Models\Inputs::updateOrCreate(['id' => 13], ['title_ar' => 'الي حي', 'title_en' => 'To Neighborhood', 'name' => 'to_neighborhood', 'type' => 'text']);
        \App\Models\Inputs::updateOrCreate(['id' => 14], ['title_ar' => 'الي طابق', 'title_en' => 'To Floor', 'name' => 'to_floor', 'type' => 'text']);
        \App\Models\Inputs::updateOrCreate(['id' => 15], ['title_ar' => 'الي منزل', 'title_en' => 'To House', 'name' => 'to_house', 'type' => 'text']);
