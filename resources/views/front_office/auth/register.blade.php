            ...
            <div style="width: 400px;margin-bottom:80px;margin-top:60px">
                ...
                <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="first_name" type="text" placeholder="{{ __('auth.first_name') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="phone" type="text" placeholder="{{ __('auth.phone') }}">
                        @error('phone') <span class="error text-danger">{{ $message }}</span> @enderror
            
                    </div>
                    <div class="form-group">
                        <label for="" class="m-2">{{ __('auth.email') }}</label>
                        <input class="form-control" name="email" type="text" placeholder="{{ __('auth.Email') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="image" type="file" placeholder="{{ __('general.image') }}">
