...
@section('content')
    <section class="section overflow-hidden">
        ...
        <div class="container">
            <div class="row">
                ...
                <?php $departments = App\Models\Department::get(); ?>
    ...
    <section class="section bg-pattern-2 bg-image2">
        <div class="container">
            ...
            <div class="row align-items-center">
                <?php $posts_count =App\Models\Post::count()?>
                <?php $order_count =App\Models\Order::count()?>
                <?php $users_count =App\Models\User::count()?>
                <?php $providers_count =App\Models\User::where('role_id' ,3)->count()?>
    ...
    <section class="section">
        <div class="container">
            <div class="heading-section">
                <div class="heading-subtitle"><span class="tx-primary tx-16 fw-semibold">{{ __('user.providers') }}</span></div>
                <div class="heading-title">{{ __('user.providers') }}</div>
                <div class="heading-description"> </div>
            </div>
            <div class="row">
                {{-- <div class="col-lg-4"> --}}
                    <?php $users = App\Models\User::where('role_id' , 3)->limit(6)->get() ?>
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-8">
                                <div class="row">
    ...
    <section class="section">
        <div class="container">
            <div class="heading-section">
                <div class="heading-subtitle"><span class="tx-primary tx-16 fw-semibold">{{ __('general.about_us') }}</span></div>
            ...
            <div class="row">
                {{-- <div class="col-lg-4"> --}}
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-8">
                                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aperiam voluptatem at sunt incidunt nobis rerum magni sint blanditiis autem distinctio. Blanditiis iste quae eius provident quo ea molestias, temporibus commodi?</p>
