<tr class="bg-category-step{{$category->step}}">
    ...
    <td>
        <a href="{{route('admin.pages.edit', $category->id)}}" class="btn btn-primary btn-sm"><i class="la la-pencil"></i> </a>
        <a href="{{route('admin.pages.show', $category->slug)}}" class="btn btn-outline-info btn-sm" target="_blank"><i class="la la-eye"></i> </a>
    </td>
</tr>
